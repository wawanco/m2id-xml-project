...
public class Main {
	...
	private static ArrayList<Company> InitialiseCompanies() {
		...
		Company McDonalds = new Company(1, "McDonalds", 0, 0, "dollars",
				productMc);
		Company GAP = new Company(2, "GAP", 0, 20, "dollars", productGap);
		Company TravelAir = new Company(3, "TravelAir", 1, 40, "euros",
				productTA);
		Company ZARA = new Company(4, "ZARA", 2, 10, "euros", productZara);
